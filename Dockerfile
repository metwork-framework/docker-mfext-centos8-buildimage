...
#We don t want to upgrade json-c with yum-utils
RUN yum -y install wget
RUN wget http://dl.rockylinux.org/vault/rocky/8.5/BaseOS/x86_64/os/Packages/y/yum-utils-4.0.21-4.el8_5.noarch.rpm http://dl.rockylinux.org/vault/rocky/8.5/BaseOS/x86_64/os/Packages/d/dnf-plugins-core-4.0.21-4.el8_5.noarch.rpm http://dl.rockylinux.org/vault/rocky/8.5/BaseOS/x86_64/os/Packages/p/python3-dnf-plugins-core-4.0.21-4.el8_5.noarch.rpm
